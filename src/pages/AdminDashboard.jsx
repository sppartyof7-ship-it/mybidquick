  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ fontSize: 13, color: 'var(--text-muted)' }}>{tenant.ownerName} Â· {tenant.email}</div>
      </div>
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
                    ...
                    <div>
                      ...
                      <p style={{ color: 'var(--text-muted)', fontSize: 13 }}>{selectedTenant.ownerName} Â· {selectedTenant.email}</p>
                    </div>
                  </div>
