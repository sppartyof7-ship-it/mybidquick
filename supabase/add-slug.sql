...
-- Example: slug "cloute-cleaning" → cloute-cleaning.mybidquick.com
-- ============================================================================
...
-- No changes needed — the "Allow public read on tenants" policy covers SELECT.

-- Helper function: auto-generate slug from business name
-- Usage: SELECT generate_slug('Cloute Cleaning'); → 'cloute-cleaning'
